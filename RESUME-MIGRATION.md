...
- `lib/features/user_profile/data/user_profile_repository.dart:10` still uses `UserProfileRepositoryRef ref` — will fail to generate until Task 6 rewrites the file. Doesn't block other codegen.
